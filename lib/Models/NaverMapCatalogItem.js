...
var ImageryLayerCatalogItem = require("terriajs/lib/Models/ImageryLayerCatalogItem");
...
/**
 * A {@link ImageryLayerCatalogItem} representing a layer from the Naver Map server.
 *
 * @alias NaverStreetMapCatalogItem
 * @constructor
 * @extends ImageryLayerCatalogItem
 *
 * @param {Terria} terria The Terria instance.
 */
var NaverStreetMapCatalogItem = function(terria) {
...
inherit(ImageryLayerCatalogItem, NaverStreetMapCatalogItem);

Object.defineProperties(NaverStreetMapCatalogItem.prototype, {
  /**
   * Gets the type of data item represented by this instance.
   * @memberOf NaverStreetMapCatalogItem.prototype
   * @type {String}
   */
  type: {
    get: function() {
      return "naver-street-map";
    }
  },
  ...
  typeName: {
    get: function() {
      return i18next.t("models.naverStreetMap.name");
    }
  }
});

NaverStreetMapCatalogItem.prototype._createImageryProvider = function() {
...
module.exports = NaverStreetMapCatalogItem;
