...
const ImageryLayerFeatureInfo = require("terriajs-cesium/Source/Scene/ImageryLayerFeatureInfo")
  .default;
const ImageryLayerCatalogItem = require("terriajs/lib/Models/ImageryLayerCatalogItem");
const inherit = require("terriajs/lib/Core/inherit");
const knockout = require("terriajs-cesium/Source/ThirdParty/knockout").default;
const Legend = require("terriajs/lib/Map/Legend");
const overrideProperty = require("terriajs/lib/Core/overrideProperty");
