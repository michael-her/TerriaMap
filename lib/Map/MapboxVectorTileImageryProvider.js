...
/*global require*/
var computeRingWindingOrder = require("terriajs/lib/Map/computeRingWindingOrder");
...
var loadArrayBuffer = require("terriajs/lib/Core/loadArrayBuffer");
...
MapboxVectorTileImageryProvider.prototype._buildImageUrl = function(
  ...
  // michael: reverse y 와는 상관없는 문제로 보인다.
  y = this._originalUrl.indexOf("{-y}") != -1 ? Math.pow(2, level) - y - 1 : y;
  // y = this._originalUrl.indexOf('{-y}') != -1 ? this._tilingScheme.getNumberOfYTilesAtLevel(level) - y : y;
